...
count = {} # Keys are each letter, value is how often they appear in string

for character in message.upper():
    count.setdefault(character, 0) # Creates the key on first encounter, sets it's value to 0
    count[character] += 1 # Adds one for each time the key is encountered

pprint.pprint(count) # Formats dictionaries output
print()
print()
# Can save pprint output as string
rjString = pprint.pformat(count)
print(rjString)
